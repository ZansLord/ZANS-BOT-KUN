...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = kurr.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© ZansBotz OFFICIAL_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             kurr.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = kurr.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/JI25LDtPW784GAZoRD9fW9', "groupName": `${NamaBot}`, "footerText": "*_© ZansBotz OFFICIAL_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
cpref = `Hayo Ngomongin Abdul Ganteng Yaaa Aowkowkwoo`
reply(cpref)
}
if(budy.includes('Dul')){
cpref = `Hayo Ngomongin Abdul Ganteng Yaaa Aowkowkwoo`
reply(cpref)
}
           if (budy.startsWith('>')){
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*_© ZansBotz_*", [{buttonId: 'igm', buttonText: {displayText: 'Instagram'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
reply('http://instagram.com/kurrsadboy')
}
if(isButton == 'ytm'){
reply('http://youtube.com/c/ZansBotz')
}
...
*ㄖOWNER: ${NamaOwner}*
*ㄖNOMER OWNER: ${NomorOwner}*
*ㄖLib: Baileys*
*ㄖspeed bot: ${latensyi.toFixed(4)} Second*
*ㄖprefix : Multi Prefix* 
*ㄖruntime : ${waktu(runtime)}* 
...
ㄖ ${prefix}wibu
ㄖ ${prefix}puki
ㄖ ${prefix}pantexpantek
│
─❒ OWNER
ㄖ ${prefix}autorespon [ _on/off_ ]
ㄖ ${prefix}bc [ _teks/reply gif/image/video with caption_ ]
ㄖ ${prefix}tobc [ _reply sticker/audio with caption_ ]
ㄖ ${prefix}return [ _javascript_ ]
ㄖ ${prefix}clearall
ㄖ ${prefix}delchat
ㄖ ${prefix}mute
ㄖ ${prefix}unmute
ㄖ ${prefix}public
ㄖ ${prefix}self
ㄖ ${prefix}spam [ _teks|jumlah_ ]
ㄖ ${prefix}addcmd [ _teks reply stc_ ]
ㄖ ${prefix}delcmd [ _reply stc_ ]
ㄖ ${prefix}listcmd
ㄖ ${prefix}spamsw [ _teks|jumlah_ ]
ㄖ ${prefix}upswteks [ _teks_ ]
ㄖ ${prefix}upswlokasi [ _teks_ ]
ㄖ ${prefix}upswaudio [ _reply audio_ ]
ㄖ ${prefix}upswvoice [ _reply audio_ ]
ㄖ ${prefix}upswsticker [ _reply sticker_ ]
ㄖ ${prefix}upswimage [ _reply image with caption_ ]
ㄖ ${prefix}upswgif [ _reply gif with caption_ ]
ㄖ ${prefix}upswvideo [ _reply video with caption_ ]
ㄖ ${prefix}shutdown
ㄖ ${prefix}offline [ _alasan_ ]
ㄖ ${prefix}online
ㄖ ${prefix}exif [ _nama|author_ ]
ㄖ ${prefix}setprofile [ _reply image_ ]
ㄖ ${prefix}setname [ _teks_ ]
ㄖ ${prefix}setprefix [ _multi/nopref/prefix_ ]
ㄖ ${prefix}setbio [ _teks_ ]
ㄖ ${prefix}leave
ㄖ ${prefix}restart
ㄖ ${prefix}addrespon [ _tanya|jawab_ ]
ㄖ ${prefix}delrespon [ _nama_ ]
ㄖ ${prefix}listrespon
ㄖ ${prefix}readall
ㄖ ${prefix}unreadall
ㄖ ${prefix}archive
ㄖ ${prefix}unarchiveall
ㄖ ${prefix}pin
ㄖ ${prefix}unpin
ㄖ ${prefix}setmenu [ _ori/simpel_ ]
ㄖ ${prefix}setallmenu [ _ori/simpel_ ]
ㄖ ${prefix}leavetime [ _detik/menit/jam_ ]
ㄖ ${prefix}bukatime [ _detik/menit/jam_ ]
ㄖ ${prefix}tutuptime [ _detik/menit/jam_ ]
ㄖ ${prefix}nano [ _nama file_ ]
│
─❒GAME MENU
ㄖ ${prefix}tebakgambar
ㄖ ${prefix}caklontong
│
─❒ WIBU
ㄖ ${prefix}loli
...
ㄖ ${prefix}pinterest
ㄖ ${prefix}herolist
ㄖ ${prefix}herodetail [ _hero_ ]
ㄖ ${prefix}google [ _search_ ]
ㄖ ${prefix}gimage [ _search_ ]
ㄖ ${prefix}wiki [ _search_ ]
ㄖ ${prefix}mediafire [ _link_ ]
ㄖ ${prefix}ytsearch [ _judul_ ]
ㄖ ${prefix}ytmp4 [ _link yt_ ]
ㄖ ${prefix}ytmp3 [ _link yt_ ]
ㄖ ${prefix}play [ _judul lagu_ ]
ㄖ ${prefix}video [ _judul video_ ]
ㄖ ${prefix}tinyurl [ _link_ ]
ㄖ ${prefix}fetch [ _link_ ]
ㄖ ${prefix}igdl [ _link_ ]
ㄖ ${prefix}tiktokdl [ _link_ ]
ㄖ ${prefix}pinterest [ _search_ ]
ㄖ ${prefix}lirik [ _judul_ ]
ㄖ ${prefix}tourl [ _reply image/video_ ]
ㄖ ${prefix}resepmasakan [ _judul_ ]
ㄖ ${prefix}artimimpi [ _teks_ ]
ㄖ ${prefix}bilangangka [ _angka_ ]
ㄖ ${prefix}kalkulator [ _angka_ ]
ㄖ ${prefix}fancytext [ _teks_ ]
ㄖ ${prefix}githubstalk [ _username_ ]
ㄖ ${prefix}translate [ _teks kodebhs_ ]
ㄖ ${prefix}ss [ _link_ ]
ㄖ ${prefix}playstore [ _search_ ]
ㄖ ${prefix}tiktokaudio [ _link_ ]
ㄖ ${prefix}brainly [ _search_ ]
ㄖ ${prefix}igstory [ _search_ ]
ㄖ ${prefix}igstalk [ _link_ ]
ㄖ ${prefix}twitter [ _link_ ]
ㄖ ${prefix}twmp3 [ _link_ ]
ㄖ ${prefix}linkwa [ _search_ ]
ㄖ ${prefix}fb [ _link_ ]
ㄖ ${prefix}chara [ _search_ ]
ㄖ ${prefix}otaku [ _search_ ]
ㄖ ${prefix}komiku [ _search_ ]
│
─❒ MAKER
ㄖ ${prefix}blackpink
ㄖ ${prefix}neon
ㄖ ${prefix}greenneon
ㄖ ${prefix}advanceglow
ㄖ ${prefix}futureneon
ㄖ ${prefix}sandwriting
ㄖ ${prefix}sandsummer
ㄖ ${prefix}sandengraved
ㄖ ${prefix}metaldark
ㄖ ${prefix}neonlight
ㄖ ${prefix}holographic
ㄖ ${prefix}text1917
ㄖ ${prefix}minion
ㄖ ${prefix}deluxesilver
ㄖ ${prefix}newyearcard
ㄖ ${prefix}bloodfrosted
ㄖ ${prefix}halloween
ㄖ ${prefix}jokerlogo
ㄖ ${prefix}fireworksparkle
ㄖ ${prefix}natureleaves
ㄖ ${prefix}bokeh
ㄖ ${prefix}toxic
ㄖ ${prefix}strawberry
ㄖ ${prefix}box3d
ㄖ ${prefix}roadwarning
ㄖ ${prefix}breakwall
ㄖ ${prefix}icecold
ㄖ ${prefix}luxury
ㄖ ${prefix}cloud
ㄖ ${prefix}summersand
ㄖ ${prefix}horrorblood
ㄖ ${prefix}thunder
ㄖ ${prefix}pornhub
ㄖ ${prefix}glitch
ㄖ ${prefix}avenger
ㄖ ${prefix}space
ㄖ ${prefix}ninjalogo
ㄖ ${prefix}marvelstudio
ㄖ ${prefix}lionlogo
ㄖ ${prefix}wolflogo
ㄖ ${prefix}steel3d
ㄖ ${prefix}wallgravity
ㄖ ${prefix}shadow
ㄖ ${prefix}cup
ㄖ ${prefix}cup1
ㄖ ${prefix}romance
ㄖ ${prefix}smoke
ㄖ ${prefix}burnpaper
ㄖ ${prefix}lovemessage
ㄖ ${prefix}undergrass
ㄖ ${prefix}love
ㄖ ${prefix}coffe
ㄖ ${prefix}woodheart
ㄖ ${prefix}woodenboard
ㄖ ${prefix}summer3d
ㄖ ${prefix}wolfmetal
ㄖ ${prefix}nature3d
ㄖ ${prefix}underwater
ㄖ ${prefix}golderrose
ㄖ ${prefix}summernature
ㄖ ${prefix}letterleaves
ㄖ ${prefix}glowingneon
ㄖ ${prefix}fallleaves
ㄖ ${prefix}flamming
ㄖ ${prefix}harrypotter
ㄖ ${prefix}carvedwood
ㄖ ${prefix}arcade8bit
ㄖ ${prefix}battlefield4
ㄖ ${prefix}pubg
ㄖ ${prefix}wetglass
ㄖ ${prefix}multicolor3d
ㄖ ${prefix}watercolor
ㄖ ${prefix}luxurygold
ㄖ ${prefix}galaxywallpaper
ㄖ ${prefix}lighttext
ㄖ ${prefix}beautifulflower
ㄖ ${prefix}puppycute
ㄖ ${prefix}royaltext
ㄖ ${prefix}heartshaped
ㄖ ${prefix}birthdaycake
ㄖ ${prefix}galaxystyle
ㄖ ${prefix}hologram3d
ㄖ ${prefix}greenneon
ㄖ ${prefix}glossychrome
ㄖ ${prefix}greenbush
ㄖ ${prefix}metallogo
ㄖ ${prefix}noeltext
ㄖ ${prefix}glittergold
ㄖ ${prefix}textcake
ㄖ ${prefix}starsnight
ㄖ ${prefix}wooden3d
ㄖ ${prefix}textbyname
ㄖ ${prefix}writegalacy
ㄖ ${prefix}galaxybat
ㄖ ${prefix}snow3d
ㄖ ${prefix}birthdayday
ㄖ ${prefix}goldplaybutton
ㄖ ${prefix}silverplaybutton
ㄖ ${prefix}freefire
ㄖ ${prefix}foliokanan [ _text_ ]
ㄖ ${prefix}foliokiri [ _text_ ]
ㄖ ${prefix}nuliskanan [ _text_ ]
ㄖ ${prefix}nuliskiri [ _text_ ]
ㄖ ${prefix}maker3d [ _text_ ]
ㄖ ${prefix}maker2d [ _text_ ]
ㄖ ${prefix}epepserti [ _text_ ]
│
──❒ GROUP
ㄖ ${prefix}getpict [ _@tag_ ]
ㄖ ${prefix}getname [ _reply target_ ]
ㄖ ${prefix}getbio [ _reply target_ ]
ㄖ ${prefix}antilink [ _on/off_ ]
ㄖ ${prefix}antivirtex [ _on/off_ ]
ㄖ ${prefix}antiwame [ _on/off_ ]
ㄖ ${prefix} welcome [ _on/off_ ]
ㄖ ${prefix}creategrup [ _nama|@tag_ ]
ㄖ ${prefix}tictactoe [ _@tag_ ]
ㄖ ${prefix}delttt
ㄖ ${prefix}kick
ㄖ ${prefix}add
ㄖ ${prefix}setgrupname
ㄖ ${prefix}getpp
ㄖ ${prefix}antiwame
ㄖ ${prefix}getdeskgc
ㄖ ${prefix}sider [ _reply pesan bot_ ]
ㄖ ${prefix}hacked [ _teks_ ]
ㄖ ${prefix}setnamegc [ _teks_ ]
ㄖ ${prefix}setdeskgc [ _teks_ ]
ㄖ ${prefix}fitnah [ _@tag|teks1|teks2_ ]
ㄖ ${prefix}kontak [ _@tag|nama_ ]
ㄖ ${prefix}kontag [ _@tag|nama_ ]
ㄖ ${prefix}opengc
ㄖ ${prefix}closegc
ㄖ ${prefix}resetlinkgc
ㄖ ${prefix}linkgrup
ㄖ ${prefix}hidetag [ _teks_ ]
ㄖ ${prefix}sticktag [ _nama sticker_ ]
ㄖ ${prefix}totag [ _reply media_ ]
│
─❒ TOOLS
ㄖ ${prefix}sticker
ㄖ ${prefix}stickerwm [ _nama|author_ ]
ㄖ ${prefix}dadu
ㄖ ${prefix}semoji [ _emoji_ ]
ㄖ ${prefix}attp [ _teks_ ]
ㄖ ${prefix}ttp [ _teks_ ]
ㄖ ${prefix}ttp2 [ _teks_ ]
ㄖ ${prefix}ttp3 [ _teks_ ]
ㄖ ${prefix}ttp4 [ _teks_ ]
ㄖ ${prefix}toimg
ㄖ ${prefix}tomp3 [ _reply video_ ]
ㄖ ${prefix}tomp4 [ _reply sticker gif_ ]
ㄖ ${prefix}robot [ _reply audio_ ]
ㄖ ${prefix}balik [ _reply audio_ ]
ㄖ ${prefix}bass [ _reply audio_ ]
ㄖ ${prefix}gemuk [ _reply audio_ ]
ㄖ ${prefix}detikvn [ _reply audio caption angka_ ]
ㄖ ${prefix}detikvideo [ _reply video caption angka_ ]
│
│
─❒ STORAGE
ㄖ ${prefix}listimage
ㄖ ${prefix}liststicker
ㄖ ${prefix}listvn
ㄖ ${prefix}addsticker [ _nama_ ]
ㄖ ${prefix}delsticker [ _nama_ ]
ㄖ ${prefix}addvn [ _nama_ ]
ㄖ ${prefix}delvn [ _nama_ ]
ㄖ ${prefix}addimage [ _nama_ ]
ㄖ ${prefix}delimage [ _nama_ ]
│
─❒ MENU HARAM
ㄖ ${prefix}bokep
ㄖ ${prefix}neko
...
ㄖ ${prefix}animefeets
ㄖ ${prefix}animebooty
ㄖ ${prefix}animethighss
ㄖ ${prefix}hentaiparadise
ㄖ ${prefix}animearmpits
ㄖ ${prefix}hentaifemdom
ㄖ ${prefix}lewdanimegirls
ㄖ ${prefix}biganimetiddies
ㄖ ${prefix}animebellybutton
ㄖ ${prefix}hentai4everyone
ㄖ ${prefix}bj
ㄖ ${prefix}ero
ㄖ ${prefix}cum
ㄖ ${prefix}feet
...
ㄖ ${prefix}apakah
ㄖ ${prefix}bisakah
ㄖ ${prefix}caripesan [ _teks|jumlah_ ]
ㄖ ${prefix}slots
ㄖ ${prefix}suit [ _gunting/batu/kertas_ ]
ㄖ ${prefix}tag [ _nomor_ ]
ㄖ ${prefix}tagme
ㄖ ${prefix}tts [ _kodebhs teks_ ]
ㄖ ${prefix}readmore [ _teks1|teks2_ ]
ㄖ ${prefix}fitnahpc [ _nomor|teks1|teks2_ ]
ㄖ ${prefix}chat [ _nomor|teks_ ]
ㄖ ${prefix}fdeface [ _replyimg link|teks1|teks2_ ]
ㄖ ${prefix}listgrup
ㄖ ${prefix}baileys [ _reply message_ ]
ㄖ ${prefix}q [ _reply message_ ]
ㄖ ${prefix}getcaption [ _reply message_ ]
ㄖ ${prefix}tospam [ _reply audio/sticker/image|jumlah_ ]
ㄖ ${prefix}sharelock [ _teks1|teks2_ ]
─❒ SOUND MENU
ㄖ ${prefix}sound1 - ㄖ ${prefix}sound75

𝘘𝘜𝘖𝘛𝘌𝘚  : ${quotes}
└─────────────────❒`
sendButLocation(from, `${menu}`, "*_© ZansBotz OFFICIAL_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`store`,buttonText:{displayText:'𝙨𝙩𝙤𝙧𝙚 𝙢𝙚𝙣𝙪'},type:1},{buttonId:`sc`,buttonText:{displayText:'SC'},type:1},{buttonId:`catalog`,buttonText:{displayText:'CATALOG MENU'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
...
𝘘𝘜𝘖𝘛𝘌𝘚  : ${quotes}`
sendButLocation(from, `${menu}`, "*_© This Me ZansLord_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`allmenu`,buttonText:{displayText:'ALL MENU'},type:1},{buttonId:`rules`,buttonText:{displayText:'RULES'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Hai Kak ${pushname}, ${tampilUcapan}
...
📥 BERMINAT ? HUBUNGI :
https://bit.ly/BeliRdpBang ( ZansBotz )


*MATURSUWUN MONGGO DI LARISI*`
sendButLocation(from, `${menu}`, "*_© Iklan ZansLord_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`menu`,buttonText:{displayText:'BACK TO MENU'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Hai Kak ${pushname}, ${tampilUcapan}
...
ɢɪᴛʜᴜʙ ᴏᴡɴᴇʀ:https://github.com/ZansLord
ʸᵒᵘᵗᵘᵇᵉ ᵒʷⁿᵉʳ:https://youtube.com/c/ZansLord`
sendButLocation(from, `${menu}`, "*_© ZansBotz KUN_*", {jpegThumbnail:logonya,name:""}, [{buttonId:`menu`,buttonText:{displayText:'SIAP OM🐼'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
break
case 'verify':
...
break
		...
		case 'sewabot':
		case 'sourcecode':
		anu =`*SC? NIH TOD https://github.com/ZansLord/ZANS-BOTZ-KUN*`
 buttons = [
...
"templateMessage": {
						"hydratedTemplate": {
							...
							"hydratedFooterText": `ZansBotz OFFICIAL `,
							"hydratedButtons": [
								{
									"quickReplyButton": {
...
"templateMessage": {
  ...
  "hydratedTemplate": {
    "hydratedContentText": `Hi Mamank ${pushname} 👋,\n\n${jmn} - ${week} ${weton} - ${calender}`,
    "hydratedFooterText": `ZansBotz OFFICIAL`,
    "hydratedButtons": [
      {
        "urlButton": {
          "displayText": `Script ${NamaBot}`,
          "url": "https://github.com/ZansLord/ZANS-BOTZ-KUN"
        },
        "index": 0
      }
    ]
...
case 'chiisaihentai':
                ...
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
              buff = await getBuffer(`https://api.lolhuman.xyz/api/random/nsfw/${command}?apikey=ZansBotz`)
              buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await kurr.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'✗✗✗ ZansLord', imageMessage: imageMsg,
              contentText:`FomLow github : ZansLord`,buttons,headerType:4}
              ...
              break
                    ...
                    case 'meme':
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
              buff = await getBuffer(`https://api.lolhuman.xyz/api/meme/darkjoke?apikey=ZansBotz`)
              buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await kurr.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'✗✗✗ ZansLord', imageMessage: imageMsg,
              contentText:`FomLow github : ZansLord`,buttons,headerType:4}
...
case 'bj':
                ...
                case 'nsfw_avatar':
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
               buff = await getBuffer(`https://api.lolhuman.xyz/api/random2/${command}?apikey=ZansBotz`)
                buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await kurr.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'✗✗✗ ZansLord', imageMessage: imageMsg,
              contentText:`FomLow github : ZansLord`,buttons,headerType:4}
...
case 'blackpink':
                ...
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    ...
                    ini_txt = args.join(" ")
                    getBuffer(`https://api.lolhuman.xyz/api/textprome/${command}?apikey=ZansBotz&text=${ini_txt}`).then((gambar) => {
                        kurr.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `FomLow github : ZansLord`, quoted : ftrol})
                    })
                    break
                case 'pornhub':
                case 'glitch':
                ...
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    ...
                    txt1 = args[0]
                    txt2 = args[1]
                    getBuffer(`https://api.lolhuman.xyz/api/textprome2/${command}?apikey=ZansBotz&text1=${txt1}&text2=${txt2}`).then((gambar) => {
                        kurr.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `FomLow github : ZansLord`, quoted : ftrol})
                    })
                    break
case 'neko':
       ...
       if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
              reply(mess.wait)
              buff = await getBuffer(`https://api.lolhuman.xyz/api/random/${command}?apikey=ZansBotz`)
              buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await kurr.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'✗✗✗ ZansLord', imageMessage: imageMsg,
              contentText:`klik Next untuk ke gambar selanjut nya`,buttons,headerType:4}
       ...
       if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
              reply(mess.wait)
              buff = await getBuffer(`https://api.lolhuman.xyz/api/random/nsfw/hentai?apikey=ZansBotz`)
              buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await kurr.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'✗✗✗ ZansLord', imageMessage: imageMsg,
              contentText:`klik Next untuk ke gambar selanjut nya`,buttons,headerType:4}
              ...
              break
                ...
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    if (args.length == 0) return reply(`Example: ${prefix + command} Kurr Xd`)
                    ini_txt = args.join(" ")
                    getBuffer(`https://api.lolhuman.xyz/api/photooxy1/${command}?apikey=ZansBotz&text=${ini_txt}`).then((gambar) => {
                        kurr.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `FomLow github : ZansLord`, quoted : ftrol})
                    })
                    break
                case 'arcade8bit':
                ...
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    ...
                    txt1 = args[0]
                    txt2 = args[1]
                    getBuffer(`https://api.lolhuman.xyz/api/photooxy2/${command}?apikey=ZansBotz&text1=${txt1}&text2=${txt2}`).then((gambar) => {
                        kurr.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `FomLow github : ZansLord`, quoted : ftrol})
                    })
                    break
                ...
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    if (args.length == 0) return reply(`Example: ${prefix + command} kurr xd`)
                    ini_txt = args.join(" ")
                    getBuffer(`https://api.lolhuman.xyz/api/ephoto1/${command}?apikey=ZansBotz&text=${ini_txt}`).then((gambar) => {
                        kurr.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `FomLow github : ZansLord`, quoted : ftrol}) 
                    })
                    break
...
if (tebakgambar.hasOwnProperty(sender.split('@')[0])) return reply("Selesein yg sebelumnya dulu atuh")
  get_result = await fetchJson(`https://api.lolhuman.xyz/api/tebak/gambar?apikey=ZansBotz`)
...
break
       ...
       if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
              ...
              get_result = await fetchJson(`https://api.lolhuman.xyz/api/tebak/caklontong?apikey=ZansBotz`)
              get_result = get_result.result
              jawaban = get_result.answer
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
...
kurr.sendMessage(from, {url: `${pint[Math.floor(Math.random() * pint.length)]}`}, image, {quoted: mek, thumbnail: Buffer.alloc(0), caption: "Subscribe ZansBotz"})
break
case 'isbaileys': 
case 'bail': 
case 'baileys':
...
break
            ...
            break
              ...
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					...
					atetepe = await getBuffer(`https://api.lolhuman.xyz/api/${command}?apikey=ZansBotz&text=${encodeURIComponent(c)}`)
